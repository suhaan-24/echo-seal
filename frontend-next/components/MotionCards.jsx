        ...
        <section
            ...
            <div className="motion-card__cards-area">
                ...
                <div ref={containerRef} className="motion-card__cards">
                    <div className="motion-card__card motion-card__card--1">
                        <div className="motion-card__card-image">
                            <img
                                src="https://placehold.co/1000x1000/1a1a1a/FFF?text=Zero-Trust"
                                loading="lazy"
                                width={1000}
                                height={1000}
                                alt=""
                    ...
                    <div className="motion-card__card motion-card__card--2">
                        <div className="motion-card__card-image">
                            <img
                                src="https://placehold.co/1000x1000/1a1a1a/FFF?text=AI+Voice+Check"
                                loading="lazy"
                                width={1000}
                                height={1000}
                                alt=""
                    ...
                    <div className="motion-card__card motion-card__card--3">
                        <div className="motion-card__card-image">
                            <img
                                src="https://placehold.co/1000x1000/1a1a1a/FFF?text=Security"
                                loading="lazy"
                                width={1000}
                                height={1000}
                                alt=""
                    ...
                    <div className="motion-card__card motion-card__card--4">
                        <div className="motion-card__card-image">
                            <img
                                src="https://placehold.co/1000x1000/1a1a1a/FFF?text=Provenance"
                                loading="lazy"
                                width={1000}
                                height={1000}
                                alt=""
                ...
                <div ref={containerRef} className="motion-card__floating-labels">
                    <div className="motion-card__floating-label motion-card__floating-label--pink">
                        <p className="motion-card__floating-text">trust every voice you hear</p>
                    </div>
                    <div className="motion-card__floating-label motion-card__floating-label--orange">
                        <p className="motion-card__floating-text">zero-trust voice authentication</p>
                    </div>
                    <div className="motion-card__floating-label motion-card__floating-label--red">
                        <p className="motion-card__floating-text">security = peace of mind</p>
                    </div>
                </div>
            </div>
            ...
            <div className="motion-card__footer-text">
                <p className="motion-card__description">
                    To protect the next generation of voice communication,
                    you need cutting-edge verification. EchoSeal provides
                    end-to-end audio watermarking and real-time AI voice
                    authentication across every channel.
                </p>
            </div>
        </section>
    );
