...
export default function TransitionScribble() {
    useEffect(() => {
        const logoTruusClickable = document.querySelector('#main-logo-img');
        ...
        const runScribbleAnimation = (e) => {
            ...
            if (!transitionLogo) {
                ...
                const svgClone = document.querySelector('#main-logo-img').cloneNode(true);
                svgClone.style.mixBlendMode = 'normal';
